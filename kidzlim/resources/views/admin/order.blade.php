                           ...
                           <div style ="margin-top:2%"class="table-responsive">
                              <table   id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 ...
                                 @foreach($data as $row)
                                    ...
                                    <td>{{$row->OrderID}}</td>
                                    <td>{{$row->cartid}}</td>
                                    <td>{{$row->customer['CustomerFirstName']." ".$row->customer['CustomerLastName']}}</td>
                                    <td>{{$row->customer['CustomerEmail']}}</td>
                                       <td>{{$row->created_at}}</td>
                                       <td>{{$row->updated_at}}</td>
                                       <td>
                                       <a href="vieworder?id={{$row->OrderID}}" id='{{$row->OrderID}}' title="view orders"class="subcatdel btn-sm btn-warning" ><i class="fa fa-eye"></i></a>
                                       </td>
                                    </tr>
                                    @endforeach
                                 </tbody>
